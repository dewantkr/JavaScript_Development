...
buttonElement.addEventListener('click',getUserData);

// add logic for function
...
// Get User Data on the fly
inputElement = document.querySelector('#user');
inputElement.addEventListener('keyup',displayUser);
function displayUser() {
    /*var textBoxValue = inputElement.value;
    var userError = document.querySelector('#user-error');
    userError.textContent = textBoxValue;*/
    // get the textbox value
    var username = inputElement.value;
    var userError = document.querySelector('#user-error');
    if(username === ''){
